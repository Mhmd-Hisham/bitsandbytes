...
__device__ __forceinline__ unsigned char dQuantizeFP4(half x) {
    ...
    x = __habs(x);
    unsigned char encoding = __hgt(x, 0.00260417f)    // 0b001
                             + __hgt(x, 0.08593750f)  // 0b010
                             + __hgt(x, 0.20833333f)  // 0b011
                             + __hgt(x, 0.29166667f)  // 0b100
                             + __hgt(x, 0.41666670f)  // 0b101
                             + __hgt(x, 0.58333300f)  // 0b110
                             + __hgt(x, 0.83333330f); // 0b111
...
__device__ __forceinline__ unsigned char dQuantizeNF4(half x) {
    // the values for this tree was generated by test_normal_map_tree
    // in the file tests/test_functional.py
    unsigned char encoding = __hgt(x, -0.8480964004993439f)     // 0b0001
                             + __hgt(x, -0.6106329262256622f)   // 0b0010
                             + __hgt(x, -0.4599952697753906f)   // 0b0011
                             + __hgt(x, -0.33967943489551544f)  // 0b0100
                             + __hgt(x, -0.23460740596055984f)  // 0b0101
                             + __hgt(x, -0.13791173323988914f)  // 0b0110
                             + __hgt(x, -0.045525018125772476f) // 0b0111
                             + __hgt(x, 0.03979014977812767f)   // 0b1000
                             + __hgt(x, 0.1202552504837513f)    // 0b1001
                             + __hgt(x, 0.2035212516784668f)    // 0b1010
                             + __hgt(x, 0.2920137718319893f)    // 0b1011
                             + __hgt(x, 0.3893125355243683f)    // 0b1100
                             + __hgt(x, 0.5016634166240692f)    // 0b1101
                             + __hgt(x, 0.6427869200706482f)    // 0b1110
                             + __hgt(x, 0.8614784181118011f);   // 0b1111
    return encoding;
}
