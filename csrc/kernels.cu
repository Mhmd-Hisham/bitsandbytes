...
__device__ __forceinline__ unsigned char dQuantizeNF4(float x) {
    ...
    unsigned char encoding = (x > -0.8480964004993439f)     // 0b0001
                             + (x > -0.6106329262256622f)   // 0b0010
                             + (x > -0.4599952697753906f)   // 0b0011
                             + (x > -0.33967943489551544f)  // 0b0100
                             + (x > -0.23460740596055984f)  // 0b0101
                             + (x > -0.13791173323988914f)  // 0b0110
                             + (x > -0.045525018125772476f) // 0b0111
                             + (x > 0.03979014977812767f)   // 0b1000
                             + (x > 0.1202552504837513f)    // 0b1001
                             + (x > 0.2035212516784668f)    // 0b1010
                             + (x > 0.2920137718319893f)    // 0b1011
                             + (x > 0.3893125355243683f)    // 0b1100
                             + (x > 0.5016634166240692f)    // 0b1101
                             + (x > 0.6427869200706482f)    // 0b1110
                             + (x > 0.8614784181118011f);   // 0b1111
    return encoding;
}
